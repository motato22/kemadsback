    ...
    <div class="relative w-full max-w-4xl aspect-video bg-black rounded-[2rem] p-4 shadow-2xl border-8 border-gray-800 ring-4 ring-gray-900">
        ...
        <div class="w-full h-full bg-white dark:bg-gray-800 rounded-xl overflow-hidden flex flex-col relative">
            ...
            <div class="relative p-6 bg-[#002557] text-white text-center shadow-md">
                <h2 class="text-3xl font-bold" style="font-family: 'Montserrat', sans-serif;"><?php echo e($survey->name); ?></h2>
                <p class="text-sm mt-1 text-[#6CCAFF]">
                    <?php echo e($survey->type === 'trivia' ? '¡Demuestra lo que sabes y gana un premio!' : 'Tu opinión es muy importante para nosotros'); ?>

                </p>
                <p class="absolute top-6 right-6 text-xs text-gray-400">Timeout: <?php echo e($survey->timeout_seconds); ?>s</p>
            </div>

            <div class="flex-1 overflow-y-auto p-8 space-y-8 bg-gray-100 dark:bg-gray-800/50">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $survey->questions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $question): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $question->options; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $option): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="px-4 py-4 text-left rounded-lg border-2 border-gray-200 dark:border-gray-600 bg-gray-50 dark:bg-gray-800 flex items-center justify-between">
                                    <span class="text-gray-700 dark:text-gray-200 font-medium"><?php echo e($option->option_text); ?></span>

                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($survey->type === 'trivia' && $option->is_correct): ?>
...
<?php /**PATH /Volumes/Zack/Apps/tabletas back/resources/views/components/survey-preview.blade.php ENDPATH**/ ?>