...
<div class="kemads-login-wrap">
    <img
        src="<?php echo e(asset('images/kemads-login-dark.png')); ?>"
        alt="KEMADS"
        class="kemads-logo-dark"
    >
    <img
        src="<?php echo e(asset('images/kemads-login-light.png')); ?>"
        alt="KEMADS"
        class="kemads-logo-light"
    >
</div><?php /**PATH /Volumes/Zack/Apps/tabletas back/resources/views/components/kemads-login-logo.blade.php ENDPATH**/ ?>